...
function keepfood (){
	console.log ("keepFood");
		...
		description.innerHTML = "Je houd je eten bij je. De pestkop vindt dat niet kunnen en wilt je slaan. Gelukkig kan je de pestkop verassen en geef je hem een uppercut. De pestkop laat je met rust voor nu en jij een lekker je eten op, maar er loopt een bewaker naar je toe die vraagt of je mee wilt komen.";
...
function kantoor (){
	...
	if (key == 0){
		...
		inventoryItem.onclick = function(){sleutel()};
...
function eindDeur (){
	...
	if (key == 1){
		...
		button1.innerHTML = "Ga terug naar je cel";
		button2.innerHTML = "Open de deur";
